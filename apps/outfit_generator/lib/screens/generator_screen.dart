      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 12),
            Expanded(flex: 3, child: _buildSlot(ClothingType.bottom, "Bottom", 1)),
            SizedBox(height: 12),
            Expanded(flex: 2, child: _buildSlot(ClothingType.shoes, "Shoes", 2)),
          ],
        ),
      ),
    );
  ...
  Widget _buildSlot(ClothingType type, String placeholder, int index) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final offset = isSpinning ? (index % 2 == 0 ? 50.0 : -50.0) * _controller.value : 0.0;
                ...
                child: item == null
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.add_a_photo, size: 48, color: Colors.grey[300]),
                            Text(placeholder, style: TextStyle(color: Colors.grey, fontSize: 24, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      )
                    : Image.file(
